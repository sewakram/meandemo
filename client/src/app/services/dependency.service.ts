...
export class DependencyService {
  ...
  getsingleregion(rid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.get('http://3.95.92.70:5000/hierarchy/region/' + rid, { headers: headers })
      .map(res => res.json());
  }
  ...
  getsingleroute(roid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.get('http://3.95.92.70:5000/hierarchy/route/' + roid, { headers: headers })
      .map(res => res.json());
  }
  ...
  getsingleblock(bid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.get('http://3.95.92.70:5000/hierarchy/block/' + bid, { headers: headers })
      .map(res => res.json());
  }
  ...
  updatecountry(cid, data) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.put('http://3.95.92.70:5000/hierarchy/country/' + cid, data, { headers: headers })
      .map(res => res.json());
  }
  ...
  deletecountry(cid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.delete('http://3.95.92.70:5000/hierarchy/country/'+ cid,{ headers: headers })
      .map(res => res.json());
  }
  ...
  updatestate(cid, data) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.put('http://3.95.92.70:5000/hierarchy/state/' + cid, data, { headers: headers })
      .map(res => res.json());
  }
  ...
  updateregion(rid, data) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.put('http://3.95.92.70:5000/hierarchy/region/' + rid, data, { headers: headers })
      .map(res => res.json());
  }
  ...
  deleteregion(rid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.delete('http://3.95.92.70:5000/hierarchy/region/'+ rid,{ headers: headers })
    .map(res => res.json());
    }
  ...
  updateroute(roid, data) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.put('http://3.95.92.70:5000/hierarchy/route/' + roid, data, { headers: headers })
      .map(res => res.json());
  }
  ...
  deleteroute(roid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.delete('http://3.95.92.70:5000/hierarchy/route/'+ roid,{ headers: headers })
    .map(res => res.json());
    }
  ...
  updateblock(bid, data) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.put('http://3.95.92.70:5000/hierarchy/block/' + bid, data, { headers: headers })
      .map(res => res.json());
  }
  ...
  deleteblock(bid) {
    ...
    headers.append('Authorization', this.navbarservice.authToken);
    headers.append('Content-Type', 'application/json');
    return this.http.delete('http://3.95.92.70:5000/hierarchy/block/'+ bid,{ headers: headers })
    .map(res => res.json());
  }
